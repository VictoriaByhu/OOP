...
namespace P04_InfernoInfinity
{
    ...
    "Pesho",
    3,
    "Used for C# OOP Advanced Course -\r\nEnumerations and Attributes.",
    "Pesho", "Svetlio"
    )]
    public class Weapon
    {
    ...
    class Program
    {
        static void Main()
        {
            ...
            while ((input = Console.ReadLine()) != "END")
            {
                ...
                else if (command == "Author" || command == "Revision" || command == "Description" || command == "Reviewers")
                {
                    Type weaponType = typeof(Weapon);
                    var attribute = (CustomClassAttribute)Attribute.GetCustomAttribute(weaponType, typeof(CustomClassAttribute));
                    if (attribute != null)
                    {
                        if (command == "Author")
                            ...
                            Console.WriteLine(string.Join(", ", attribute.Reviewers));
                    }
                }
            }
        }
